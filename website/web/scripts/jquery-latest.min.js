...
!(function (a, b) {
      ...
      if (p && !e) {
        ...
        if (c.qsa && (!q || !q.test(a))) {
          if (
            ...
            (w = b),
            (x = k === 9 && a),
            k === 1 && "object" !== b.nodeName.toLowerCase())
          ) {
            (o = g(a)),
              (r = b.getAttribute("id"))
                ? (s = r.replace(bb, "\\$&"))
    ...
    (pb.prototype = d.filters = d.pseudos),
      ...
      (g = fb.tokenize =
        function (a, b) {
          ...
          return b ? h.length : h ? fb.error(a) : z(a, i).slice();
        });
    function qb(a) {
      ...
      (i = fb.select =
        function (a, b, e, f) {
          ...
          if (((e = e || []), o.length === 1)) {
            ...
            while (i-- && !((k = j[i]), d.relative[(l = k.type)])) {
                if (
                            (m = d.find[l]) &&
                            (f = m(
    ...
    m.fn.extend({
      find: function (a) {
        ...
        if ("string" != typeof a) {
          return this.pushStack(
                    m(a).filter(function () {
                      for (b = 0; e > b; b++) if (m.contains(d[b], this)) {
                                                return !0;
                                              }
                    })
                  );
    ...
    m.fn.extend({
      has: function (a) {
        ...
        return this.filter(function () {
          for (b = 0; d > b; b++) if (m.contains(this, c[b])) {
                                    return !0;
                                  }
        });
      },
    ...
    handlers: function (a, b) {
      ...
      if (h && i.nodeType && (!a.button || "click" !== a.type)) {
        for (; i != this; i = i.parentNode || this)
                if (i.nodeType === 1 && (i.disabled !== !0 || "click" !== a.type)) {
                  for (e = [], f = 0; h > f; f++)
                    (d = b[f]),
                      (c = d.selector + " "),
                      void 0 === e[c] &&
  ...
  m.fn.extend({
    ...
    removeClass: function (a) {
      var b,
        ...
        h = 0,
        i = this.length,
        j = arguments.length === 0 || ("string" == typeof a && a);
      if (m.isFunction(a)) {
        return this.each(function (b) {
  ...
  (m.fn.load = function (a, b, c) {
    ...
    var d,
      ...
      h = a.indexOf(" ");
    return (
      h >= 0 && ((d = m.trim(a.slice(h))), (a = a.slice(0, h))),
      m.isFunction(b)
        ? ((c = b), (b = void 0))
